...
robot_true_positions_C = np.array(robot_true_positions)
robots_estimated_positions_C = np.array(robots_estimated_positions)
sigma_C = np.array(sigma)
sigma30_C = 3*sigma_C[:,0, 0]**.5
sigma31_C = 3*sigma_C[:,0, 1]**.5
sigma32_C = 3*sigma_C[:,0, 2]**.5
robots_error_C = np.array(robots_error)
robots_error_rmse_C = ((robots_error_C**2).mean(1))**0.5
...
robot_true_positions_W = np.array(robot_true_positions)
robots_estimated_positions_W = np.array(robots_estimated_positions)
sigma_W = np.array(sigma)
sigma30_W = 3*sigma_W[:,0, 0]**.5
sigma31_W = 3*sigma_W[:,0, 1]**.5
sigma32_W = 3*sigma_W[:,0, 2]**.5
robots_error_W = np.array(robots_error)
robots_error_rmse_W = ((robots_error_W**2).mean(1))**0.5
SMALL_SIZE = 16
MEDIUM_SIZE = 20
BIGGER_SIZE = 25
...
plt.subplot(311)
plt.plot(robots_error_rmse_C[:,0], label='Without communication')
plt.plot(robots_error_rmse_W[:,0], label='With communication')
plt.ylabel('RMSE error (meters)')
plt.legend()
plt.title('Comparison of with and without robot-robot communication')

plt.subplot(312)
plt.ylabel('RMSE error (meters)')
plt.plot(robots_error_rmse_C[:,1], label='Without communication')
plt.plot(robots_error_rmse_W[:,1], label='With communication')

plt.subplot(313)
plt.ylabel('RMSE error (radians)')
plt.plot(robots_error_rmse_C[:,2], label='Without communication')
plt.plot(robots_error_rmse_W[:,2], label='With communication')
